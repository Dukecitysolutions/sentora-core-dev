        ...
        if ($numrows->fetchColumn() <> 0) {
            ...
            while ($rowcron = $sql->fetch()) {
                ...
                if ($rowclient && $rowclient['ac_enabled_in'] <> 0) {
                    ...
                    $line .= $rowcron['ct_timing_vc'] . " " . $restrictinfos1 . $rowclient['ac_user_vc'] . $restrictinfos2 . $rowcron['ct_fullpath_vc'] . fs_filehandler::NewLine();
